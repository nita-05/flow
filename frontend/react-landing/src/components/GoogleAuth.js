...
const GoogleAuth = ({ onSuccess, onError }) => {
  ...
  return (
    <button
      ...
      className="w-full h-12 sm:h-14 bg-white border-2 border-gray-300 rounded-lg flex items-center justify-center hover:border-gray-400 transition-colors cursor-pointer"
    >
